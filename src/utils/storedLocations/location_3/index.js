...
export default {
  uuid: locationsUUIDs.location_3,
  name: 'location_3',
  images: [
  ...
  heading: 'Heading about the location_three in bold text',
  ...
  nearby: [
    {name: 'location_zwei', uuid: locationsUUIDs.location_2},
    {name: 'location_1', uuid: locationsUUIDs.location_1},
    {name: 'location_four', uuid: locationsUUIDs.location_4},
  ],
  coordinates: {
