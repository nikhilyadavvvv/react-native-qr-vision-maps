...
export default {
  uuid: locationsUUIDs.location_1,
  name: 'location_1',
  images: [
  ...
  heading: 'Heading about the location_1 in bold text',
  ...
  nearby: [
    {name: 'location_2', uuid: locationsUUIDs.location_2},
    {name: 'location_three', uuid: locationsUUIDs.location_3},
    {name: 'location_vier', uuid: locationsUUIDs.location_4},
